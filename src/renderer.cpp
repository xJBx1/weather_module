                           ...
                           const owm_hourly_t &hourly)
{
  ...
  const float moonPhase = today.moon_phase;
  ...
  if(moonPhase == 0 || moonPhase == 1){
    display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_new_48x48, 48, 48, GxEPD_BLACK);
  } else if (moonPhase<0.25){
      display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_waxing_crescent_3_48x48, 48, 48, GxEPD_BLACK);
  } else if (moonPhase == 0.25){
      display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_first_quarter_48x48, 48, 48, GxEPD_BLACK);
  } else if(moonPhase<0.5){
      display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_waxing_gibbous_3_48x48, 48, 48, GxEPD_BLACK);
  } else if(moonPhase == 0.5){
      display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_full_48x48, 48, 48, GxEPD_BLACK);
  } else if (moonPhase<0.75){
      display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_waning_gibbous_3_48x48, 48, 48, GxEPD_BLACK);
  }else if (moonPhase == 0.75){
      display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_third_quarter_48x48, 48, 48, GxEPD_BLACK);
  }else {
      display.drawInvertedBitmap(0, 204 + (48 + 8) * 4,
                             wi_moon_alt_waning_crescent_5_48x48, 48, 48, GxEPD_BLACK);
  }
  ...
  drawString(48, 204 + 10 + (48 + 8) * 4, "Moon Cycle", LEFT);
#endif
  ...
  drawString(170 + 48, 204 + 10 + (48 + 8) * 4, "Hourly Rain", LEFT);
#endif
 ...
 || defined(WIND_INDICATOR_CPN_TERTIARY_INTERCARDINAL)
  ...
  //rain volume per hour
  display.setFont(&FONT_12pt8b);
  dataStr = String(hourly.rain_1h, 1);
